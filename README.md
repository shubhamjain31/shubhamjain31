...
<p><em>Software Engineer at <a href="https://www.leadsconnect.in/">LeadsConnect Private Service</a><img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30"> 
</em></p>
...
const shubham () => ({
    ...
    technologies: {
      ...
      misc: ["selenium", "open-cv", "socket programming", "NLP", "PySpark", "celery", "GraphQL"]
      },
    tools: [
